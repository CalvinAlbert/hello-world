...
bool Player::Collision(Enemy* o1)
{
	switch (collisionMethod)
	{
	case CollisionMethod::TopLeft:
		return Collision1(o1);
		//break; 
	case CollisionMethod::Centre:
		return Collision2(o1);
		//break;
	case CollisionMethod::InsideRect:
		return Collision3(o1);
		//break;
	default:
		return false;
		//break;
...
bool Player::Collision1(Enemy* o1)
{
	int x1 = o1->x;
	int y1 = o1->y;
	int x2 = x;
...
bool Player::Collision2(Enemy* o1)
{
	int w1 = al_get_bitmap_width(o1->bmp);
	int h1 = al_get_bitmap_height(o1->bmp);
	int w2 = al_get_bitmap_width(bmp);
	int h2 = al_get_bitmap_height(bmp);
	int x1 = o1->x + w1 / 2;
	int y1 = o1->y + h1 / 2;
	int x2 = x + w2 / 2;
	int y2 = y + h2 / 2;
...
bool Player::Collision3(Enemy* o1)
{
